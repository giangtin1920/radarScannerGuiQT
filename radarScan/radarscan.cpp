...
void radarScan::initGraphicRadar()
{
    ...
    radarScanBG =  new QGraphicsPixmapItem(QPixmap("RadarScanBG.png").scaled(225, 450, Qt::KeepAspectRatio));
    ...
    {
        markerObj = new QGraphicsPixmapItem(QPixmap(test.nameCar[i]+".png"));
